...
import { User, Mail, Lock, Eye, EyeOff, Award } from 'lucide-react'
        ...
        <div className="flex-1 flex items-center justify-center lg:justify-end pr-0 lg:pr-8 mb-8 lg:mb-0">
          <div className="text-center lg:text-right">
            ...
            <p className="text-emerald-100 mb-6">
              Manage notices and academic content
            </p>
            <div className="flex justify-center lg:justify-end space-x-4 text-sm">
              <Link to="/login/student" className="text-emerald-200 hover:text-emerald-100 font-medium">
                Student Login
              </Link>
              <span className="text-emerald-300">•</span>
              <Link to="/login/admin" className="text-emerald-200 hover:text-emerald-100 font-medium">
                Admin Login
              </Link>
            </div>
          </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-600">
                    New faculty member?{' '}
                    <Link to="/register/faculty" className="font-medium text-teal-600 hover:text-teal-500">
                      Register here
                    </Link>
                  </p>
                </div>
