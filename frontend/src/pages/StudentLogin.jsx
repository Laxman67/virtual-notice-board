        ...
        <div className="flex-1 flex items-center justify-center lg:justify-end pr-0 lg:pr-8 mb-8 lg:mb-0">
          <div className="text-center lg:text-right">
            ...
            <p className="text-blue-100 mb-6">
              Access your notices and academic updates
            </p>
            <div className="flex justify-center lg:justify-end space-x-4 text-sm">
              <Link to="/login/faculty" className="text-blue-200 hover:text-blue-100 font-medium">
                Faculty Login
              </Link>
              <span className="text-blue-300">•</span>
              <Link to="/login/admin" className="text-blue-200 hover:text-blue-100 font-medium">
                Admin Login
              </Link>
            </div>
          </div>
